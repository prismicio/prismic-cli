...
function help(config) {
  console.log(getUsage([
    ...
    },
    {
      header: 'Examples',
      content: [
        { name: '$ prismic init', summary: 'Create a project with interactive configuration' },
    ...
    },
    {
      header: 'Command List',
      content: [
        { name: 'init', summary: 'Create a project: initialize the code from a template for an existing prismic repository.' },
        { name: 'init-new', summary: 'Create a project: initialize the code for a new prismic repository.' },
...
function main() {
  var validCommands = [ null, 'init', 'init-new', 'quickstart', 'heroku', 'login', 'logout', 'signup', 'base', 'version', 'list' ];
  ...
  .then(function (config) {
    ...
    case 'init-new':
      ...
      break;
    case 'quickstart':
      init(config, firstArg, Object.assign(args, {'--new': true, '--template': 'NodeJS'}));
      break;
    case 'heroku':
      heroku(config, args);
      break;
