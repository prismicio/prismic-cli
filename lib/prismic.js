...
import { init as initSlices } from './nuxt-slices';
import { init as initSlices2 } from './nuxt-slices/index2';
...
function main() {
  const validCommands = [null, 'init', 'new', 'theme', 'quickstart', 'heroku', 'nuxt-slices', 'nuxt-slices2', 'login', 'logout', 'signup', 'base', 'version', 'list'];
