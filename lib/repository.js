...
function queryCreateRepository(base, domain, cookies, customTypes, users) {
...
async function createWithDomain(base, domain, args, customTypes, users, noconfirm) {
  ...
  await queryCreateRepository(base, domain, cookies, customTypes, users);
...
function isGithubRepository(url) {
  ...
  const regexp = /^https?:\/\/github\\.com\/[\\w\\-\\.]+\/([\\w\\-\\.]+)(\\.git)?$/;
...
function isGithubZip(url) {
  const regexp = /^https:\/\/github\\.com\/[\\w\\-\\.]+\/([\\w\\-\\.]+)(\/([\\w\\-\\.]+))+\/([\\w\\-\\.]+)\.zip$/;
  const matches = url.match(regexp);
  if (matches) {
