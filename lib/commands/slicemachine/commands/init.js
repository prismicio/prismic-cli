...
function handleRecap(manifest, library, info) {
  ...
  const vars = {
    quickStartDocsUrl: 'https://slicemachine.dev/docs/quick-start',
    addSlicesDocsUrl: 'https://slicemachine.dev/docs/add-your-own-slices',
    ...
    sliceZoneReadmeUrl: 'https://github.com/prismicio/sm-commons/tree/master/packages/vue-slicezone',
