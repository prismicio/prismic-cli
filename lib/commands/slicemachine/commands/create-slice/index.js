...
export default async function () {
  ...
  try {
    await Slices.createRemote(framework, prismicEndpoint, sliceName);
    await Slices.createLocal(framework, sliceName, /* modelWithPath */ null, libPath, path.join(__dirname, '../../templates'));
  } catch (e) {
