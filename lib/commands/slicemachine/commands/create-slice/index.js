...
export default async function () {
  ...
  try {
    ...
    await Slices.createRemote(ctx.SliceMachine.framework, prismicEndpoint, sliceName, templatesPath);
    await Slices.createLocal(ctx.SliceMachine.framework, sliceName, /* modelWithPath */ null, libPath, templatesPath);
  } catch (e) {
    return consola.error(e.message);
  }

  console.log(`\n✅ ${ctx.SliceMachine.framework} slice created at ${libPath}!`);
