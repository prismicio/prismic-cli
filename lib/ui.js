...
function connectThenCreateRepository(base, args) {
...
exports.createRepository = function(base, args) {
  var domain = args['--domain'];
  var noconfirm = (args['--noconfirm'] === 'true');
  var domainPromise;
  if (noconfirm && domain) {
      ...
      if (!exists) {
        ...
        return confirmPromise.then(function(answers2) {
          if (answers2.confirm) {
            ...
            return connectThenCreateRepository(base, args).then(function(domain) {
