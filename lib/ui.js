...
exports.connect = function connect(base, domain, args) {
...
exports.checkNotExists = function(base, domain, args) {
  var noconfirm = (args['--noconfirm'] === 'true');
  return exports.askRepositoryName(base, domain, args).then(function(answers) {
    return api.exists(base, answers.domain).then(function (exists) {
      if (exists) {
        throw "Repository already exist.";
      } else {
        return domain;
      }
    });
...
exports.createRepository = function(base, domain, customTypes, args) {
  return exports.askRepositoryName(base, domain, args).then(function(answers) {
    ...
    return exports.connect(base, domain, args).then(function(cookies) {
      return api.createRepository(cookies, base, domain, customTypes);
