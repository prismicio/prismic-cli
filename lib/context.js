...
function parseArgs(args) {
  ...
  return {
    ...
    dangerousDelete: argsMap['--dangerous-delete'],
    slices: argsMap['--slices'],
...
export function build(command, args) {
  ...
  ctx = {
    ...
    dangerousDelete: parsedArgs.dangerousDelete,
    slices: parsedArgs.slices,
    customTypes: parsedArgs.customTypes,
    Auth: {
